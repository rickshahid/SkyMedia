...
//        public static void Run([QueueTrigger(Constant.Storage.Blob.WorkflowContainerName)] EventGridEvent queueMessage,
...
//                                    {
//                                        CreateAssetJob(mediaClient, workflowManifest, blob, logger);
//                                    }
//                                    else
//                                    {
...
//        private static void CreateAssetJob(MediaClient mediaClient, MediaWorkflowManifest workflowManifest, CloudBlockBlob blob, ILogger logger)
//        {
//            Asset inputAsset = mediaClient.CreateAsset(workflowManifest.OutputAssetStorage, workflowManifest.AssetName, blob);
...
//                };
//                Job job = mediaClient.CreateJob(transform.Name, workflowManifest.JobName, null, workflowManifest.JobPriority, inputFileUrl, inputAsset, workflowManifest.OutputAssetStorage, workflowManifest.JobOutputPublish, outputInsight);
