...
namespace AzureSkyMedia.PlatformServices
{
    internal class DocumentClient : IDisposable
    {
        ...
        public DocumentClient(bool readWrite)
        {
            string settingKey = readWrite ? Constant.AppSettingKey.AzureCosmosDocumentReadWrite : Constant.AppSettingKey.AzureCosmosDocumentReadOnly;
            ...
            _cosmos = new DocClient(new Uri(accountEndpoint), accountKey);
        }
        ...
        public void Initialize()
        {
            ...
            ResourceResponse<DocumentCollection> collection =_cosmos.CreateDocumentCollectionIfNotExistsAsync(databaseUri, collectionId, collectionOptions).Result;

            collectionId = new DocumentCollection { Id = Constant.Database.Collection.ProcessorConfig };
            collection = _cosmos.CreateDocumentCollectionIfNotExistsAsync(databaseUri, collectionId, collectionOptions).Result;
        }
