...
As a sample illustration, the screenshot below is an introductory <a href="http://azure.microsoft.com/services/media-services/" target="_blank">Azure Media Services</a> stream that is playing within an Azure App Service Web App via <a href="http://azure.microsoft.com/services/media-services/media-player/" target="_blank">Azure Media Player</a> integration. Live or on-demand video content that is stored and managed in Azure Media Services is adaptively streamed and globally consumable across a wide range of devices and platforms.
