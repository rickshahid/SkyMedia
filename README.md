...
As an illustration, here is an introductory Azure Media Services stream that is playing via Azure Media Player integration. Azure Media Services content can be adaptively scaled and consumed across a broad spectrum of devices and platforms.
