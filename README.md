...
As a demo, here is an introductory Azure Media Services stream playing within the site via Azure Media Player integration. Azure Media Services content can be adaptively scaled and consumed across a broad spectrum of devices and platforms across the world.
