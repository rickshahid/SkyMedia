...
namespace SkyMedia.ServiceBroker
{
    internal static class Storage
    {
        ...
        public static Uri GetAccessSignatureUri(CloudBlobContainer container, TimeSpan policyDuration)
        {
        ...
        public static Uri GetAccessSignatureUri(ICloudBlob blob, TimeSpan policyDuration)
        {
            SharedAccessBlobPolicy readAccess = GetBlobReadAccess(policyDuration, null);
        ...
        public static CloudStorageAccount GetAccount(string authToken, string accountName)
        {
            string accountKey;
