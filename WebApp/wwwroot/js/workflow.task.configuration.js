...
function GetNewTaskRowHtml(lastTaskRow, lastTaskNumber, newTaskNumber) {
    ...
    taskRowHtml = ReplaceAllText(taskRowHtml, "faceDetectionAggregateEmotionInterval" + lastTaskNumber, "faceDetectionAggregateEmotionInterval" + newTaskNumber);
    ...
    taskRowHtml = ReplaceAllText(taskRowHtml, "motionHyperlapseFrameStart" + lastTaskNumber, "motionHyperlapseFrameStart" + newTaskNumber);
    taskRowHtml = ReplaceAllText(taskRowHtml, "motionHyperlapseFrameEnd" + lastTaskNumber, "motionHyperlapseFrameEnd" + newTaskNumber);
...
function SetProcessorConfig(mediaProcessor, taskNumber, encoderPresets) {
